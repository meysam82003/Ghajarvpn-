...
class SecurePaymentActivity : Activity() {
    ...
    private fun showCheckoutFailure(message: String) {
        GhajarLog.e("Payment", "checkout failure shown: $message")
        ...
        override fun onPageFinished(view: WebView?, url: String?) {
            ...
            when {
                path.contains("payment/success") || path.contains("successful") ||
                    ...
                    GhajarLog.i("Payment", "checkout succeeded")
                    setResult(RESULT_OK, Intent().putExtra(EXTRA_RESULT_URL, url))
                    finish()
                }
                path.contains("payment/cancel") || path.contains("payment/failed") ||
                    state in setOf("failed", "cancel", "canceled") -> {
                    GhajarLog.w("Payment", "checkout cancelled/failed: state=$state")
    ...
    private fun finishWithError(message: String) {
        GhajarLog.e("Payment", "checkout aborted: $message")
