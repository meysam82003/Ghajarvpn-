...
dependencies {
    ...
    // Combined gomobile AAR: gozarcore (Xray) + Psiphon tunnel in ONE Go
    // runtime. Built by scripts/build-psiphon-aar.sh (CI builds it fresh;
    // never commit it — see scripts/PSIPHON-BUILD-INSTRUCTIONS.md).
