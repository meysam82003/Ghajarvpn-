...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    ...
    PendingIntent getGraphPendingIntent() {
        // This core is embedded in Ghajar and the upstream OpenVPN UI module is
        // deliberately not packaged. Resolve the host application's launcher
        // Activity so tapping the VPN notification always opens Ghajar instead
        // of targeting the absent de.blinkt.openvpn.activities.MainActivity.
